...
@echo "Run simulation"
@rem ObirRF24Network_helloworld taken from RF24Network helloworld rx/tx example
@rem EBSimMiniProRF24Network ..\..\wsady-testowe\ObirRF24Network_helloworld\para-0000-0001\ObirRF24Network_helloworld_rx_20200505.ino.hex
EBSimMiniProRF24Network ..\..\wsady-testowe\ObirRF24Network_helloworld\para-0000-0001\ObirRF24Network_helloworld_tx_20200505.ino.hex
